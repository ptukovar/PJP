...
class pjpListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by pjpParser#id.
    def enterId(self, ctx:pjpParser.IdContext):
        pass

    # Exit a parse tree produced by pjpParser#id.
    def exitId(self, ctx:pjpParser.IdContext):
        pass
    ...
    # Enter a parse tree produced by pjpParser#lit.
    def enterLit(self, ctx:pjpParser.LitContext):
        pass

    # Exit a parse tree produced by pjpParser#lit.
    def exitLit(self, ctx:pjpParser.LitContext):
        pass
